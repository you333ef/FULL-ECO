...
import BILDING from './PAGE-ONE/BILDING';
import NotFound from './PAGE-ONE/NotFound';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='/' element={<HEAD addToFavorites={addToFavorites} />} />
        ...
        <Route path="/BILDING" element={<BILDING/>} />
